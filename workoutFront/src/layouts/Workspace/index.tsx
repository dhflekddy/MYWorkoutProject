...
//   WorkspaceWrapper,
// } from './styles';
// import { Input, Label } from '@views/SignUp/styles';
...
//       socket?.emit('login', { id: loginUser?.id, channels: channelData.map((v) => v.id) });
//     }
//   }, [socket, userData, title]);
...
//               <WorkspaceModal>
//                 <h2>{userData?.Workspaces.find((v:any) => v.url === workspace)?.name}</h2>
